...
bids_set = pl.Path("/mnt/nas6/data/Target/batch_copy/filter_register_empty_directory_fix/bids") # must be path that doesnt exist, the script creates the target dir itself
processed_set = pl.Path('/mnt/nas6/data/Target/batch_copy/filter_register_empty_directory_fix/out2')
