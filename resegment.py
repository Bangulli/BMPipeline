...
clean_set = pl.Path('/mnt/nas6/data/Target/batch_copy/reseg_test/set')#'/mnt/nas6/data/Target/PROCESSED_mrct1000_nobatch')
multimod_reseg = pl.Path('/mnt/nas6/data/Target/batch_copy/reseg_test/set_multi')#'/mnt/nas6/data/Target/nnUNet_Datasets/multimod')
reseg = pl.Path('/mnt/nas6/data/Target/batch_copy/reseg_test/set_single')#'/mnt/nas6/data/Target/nnUNet_Datasets/singlemod')
print('I am still set to the test case source data paths')
